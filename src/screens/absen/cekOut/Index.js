    ...
    if (name && position && date && time && location) {
      ...
      set(ref(db, 'Attendance/cekOut'), {
        ...
        .then((data) => {
          ...
          Alert.alert('Success', 'Your cek out success');
      ...
      <KeyboardAvoidingView
        ...
        <TouchableWithoutFeedback >
          <View style={styles.card}>
            <Text style={styles.textHeader}>sign-out attendance</Text>
            ...
            <View style={styles.form}>
              <Text style={styles.label}>Check out hours</Text>
              <TextInput
                placeholder="12 : 00"
                style={styles.textInput}
